...
class Staff: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    var pictures=[UIImage(named: "eleanor2"),UIImage(named: "katelyn"),UIImage(named: "tree")]
    var position=["Eleanor Ramseier – Camp Navigate Director","Katelyn Ellinger – Program Director", "Tree Huxford - Food Program Coordinator"
]
    var contactInfo=["Contact Information will be added shortly","Contact Information will be added shortly","Contact Information will be added shortly"]
    var biography=["Eleanor has been serving youth in the Wabash Valley for 27+ years. She began volunteering as a youth worker alongside her husband in 1990. In the most recent past, as Executive Director of the local YMCA, she helped develop and oversee the youth activities as well as the summer camps. She is the mother of three awesome adult children. She has always had a desire to encourage youth to find their passion, set goals and be strong in their faith! With Camp Navigate she can now combine these passions with another aspiration she has– developing youth to succeed in our community’s workforce! She loves spending time with family and friends, running, hiking, and anything adventurous.", "We are so blessed to have Katelyn as a part of our Camp Navigate Team!  In Katelyn’s words, “I was born to put my whole heart into our youth. My day is filled with LOVE from littles, they teach me so much!” Katelyn starts her day at Fuqua Elementary as a Special Education Assistant and continues it at Camp Navigate’s After-School Care as the Program Director! During the summer she will assist in designing and Co-Directing our programs at camp. She has two years completed at Indiana State University in Elementary Education and plans to further her education with the end goal being a kindergarten teacher. Some of her favorite days are spent with friends, her fur babies and being outdoors in the sunshine!","Teresa, otherwise known as ”Tree”, has a passion for working with children. She graduated from Indiana State University and Buffalo State College majoring in education. She enjoys teaching students, giving them confidence and skills for a successful future. She retired after 30 years in the classroom many of them at Sarah Scott Middle School. Tree is excited to work with kids again but in a different capacity. Working as the ”lunch lady” at Camp Navigate will give her the opportunity to teach kids the benefits of healthy eating. She has one son who was diagnosed with cystic fibrosis at an early age. Working with the Cystic Fibrosis Foundation has been a passion for nearly three decades. She has volunteered in various positions including fundraising and advocacy. In her spare time, she enjoys reading and traveling. Her favorite is ”We make a living by what we get. We make a life by what we give.” Winston Churchill"  ]
