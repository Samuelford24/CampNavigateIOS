...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let locationImages = [UIImage(named: "week1"), UIImage(named: "week2"), UIImage(named: "week3"), UIImage(named: "week4"), UIImage(named: "week5"), UIImage(named: "week6"), UIImage(named: "week7"), UIImage(named: "week8"), UIImage(named: "week9"), UIImage(named: "week10")]
