...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    let locationImages = [UIImage(named: "w1"), UIImage(named: "w2"), UIImage(named: "w3"), UIImage(named: "w4"), UIImage(named: "w5"), UIImage(named: "w6"), UIImage(named: "w7"), UIImage(named: "w8"), UIImage(named: "w9"), UIImage(named: "w10")]
